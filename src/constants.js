module.exports = {
  ...
  COMMON_LANGUAGES: {
    none: 'Auto-detect', apache: 'Apache', bash: 'Bash', cr: 'Crystal', cs: 'C#', cpp: 'C++', css: 'CSS', coffeescript: 'CoffeeScript', diff: 'Diff',
    go: 'Go', haskell: 'Haskell', html: 'HTML, XML', http: 'HTTP', json: 'JSON', java: 'Java', javascript: 'JavaScript', kotlin: 'Kotlin',
